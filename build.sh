...
LINUX_DEPLOY_QT_EXCLUDE_COPYRIGHTS=true appimage-wrapper linuxdeployqt-continuous-x86_64.AppImage vlc-$VERSION/build/org.videolan.vlc.desktop  inuxdeployqt -exclude-libs=libfreetype.so.6,libharfbuzz.so.0,libxcb-dri3.so.0  -bundle-non-qt-libs
